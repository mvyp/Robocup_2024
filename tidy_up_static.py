        ...
        for i in self.object_list:
            try:
                ...
                if (self.trans.transform.translation.z > 0
                        and abs(self.trans.transform.translation.y) < 0.6
...
if __name__ == '__main__':
    ...
    navi = MoveRobot()
    rospy.sleep(2)
    #goals = [[-2.8, 2.63, -180], [-2.78, 1.55, -180], [-1.42, 3.82, 0],[-1.37,1.6,40]]#裁判会指定具体地址
    ...
    #goals =[[1.61,3.68,0],[1.61,3.68,0]]#调试机器人位置
    #goals的数据是x，y，和偏转角
    #navi.goto(bin)
        ...
        #for goal in goals:
            ...
            if len(navi.target_list) != 0:
                navi.main([                #调用navi.main()函数执行抓取
                    navi.target_list[0]-0.1612062022090129, navi.target_list[1]-0.0699,#分别是目标物体的xyz信息和旋转四元数，通过加减来微调 
                    navi.target_list[2]+0.000729, 0.46103304624557495, 0.5499841570854187,0.44626110792160034,0.5346184372901917
